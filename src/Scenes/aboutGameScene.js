...
export default class PreGameScene extends Phaser.Scene {
  ...
  create() {
    this.title = this.add.text(0, 0, 'Roshan, the treasure hunter.', { fontSize: '40px', fill: '#f05123', fontStyle: 'bold' });
    this.gameContext1 = this.add.text(50, 150, 'Meet Roshan. He has one task and one only, to be as rich as he can.', { fontSize: '17px', fill: '#adf0d1' });
